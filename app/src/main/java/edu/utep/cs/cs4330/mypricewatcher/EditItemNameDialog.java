...
public class EditItemNameDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.edit_item_name_prompt)
                .setView(input)
                .setPositiveButton(R.string.yes_dialog_button_label, (dialogInterface, i) -> listener.onItemName(this, true, input.getText().toString()))
                .setNegativeButton(R.string.no_dialog_button_label, (dialogInterface, i) -> listener.onItemName(this, false, ""));
        setCancelable(false);
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            throw new ClassCastException(context.toString() + "Need to implement EditNameDialogListener.");
        }
    }
